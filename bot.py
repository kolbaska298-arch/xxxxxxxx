...
INSULT_REPLIES = (
    "Слабая попытка. Давай что-нибудь поинтереснее.",
    "На месте. А теперь без дешёвых провокаций.",
    "Шум услышал, смысла не обнаружил.",
    "Громче не значит умнее.",
    "Принято. Следующий ход делай сильнее.",
)
